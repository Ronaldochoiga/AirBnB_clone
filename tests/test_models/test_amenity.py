...
class TestAmenityDocs(unittest.TestCase):
    """Tests to check the documentation style of Amenity class"""
    @classmethod
    def setUpClass(cls):
    ...
    def test_pep8_conformance_amenity(self):
        """Test that amenity.py conforms to pep8."""
    ...
    def test_pep8_conformance_test_amenity(self):
        """Test that test_amenity.py conforms to pep8."""
        pep8s = pycodestyle.StyleGuide(quiet=True)
    ...
    def test_amenity_module_docstring(self):
        """Test for the amenit module docstring"""
...
class TestAmenity(unittest.TestCase):
    ...
    def test_is_subclass(self):
        """Test inheritance Amenity is a sub_class of BaseModel"""
        amenity = Amenity()
    ...
    def test_name_attr(self):
        """Test emptineness of amenity with name attr"""
        amenity = Amenity()
        self.assertTrue(hasattr(amenity, "name"))
        self.assertEqual(amenity.name, "")

    def test_to_dict_creates_dict(self):
        """test to_dct creates correct attrs"""
        am = Amenity()
        print(am.__dict__)
        new_d = am.to_dict()
    ...
    def test_to_dict_values(self):
        """test whether value from dict is correct"""
