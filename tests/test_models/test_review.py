...
class TestReviewDocs(unittest.TestCase):
    ...
    def test_review_func_docstrings(self):
        """Test docstrings in Review methods"""
...
class TestReview(unittest.TestCase):
    ...
    def test_to_dict_values(self):
        ...
        self.assertEqual(new_d["created_at"], r.created_at.strftime(tim_format))
        self.assertEqual(new_d["updated_at"], r.updated_at.strftime(tim_format))
