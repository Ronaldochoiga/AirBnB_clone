...
class TestStateDocs(unittest.TestCase):
    ...
    def test_pep8_conformance_state(self):
        """Test that state.py conforms to PEP8."""
...
class TestState(unittest.TestCase):
    ...
    def test_to_dict_values(self):
        ...
        self.assertEqual(new_d["created_at"], s.created_at.strftime(tim_format))
        self.assertEqual(new_d["updated_at"], s.updated_at.strftime(tim_format))
