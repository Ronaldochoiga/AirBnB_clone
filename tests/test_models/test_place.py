...
class TestPlaceDocs(unittest.TestCase):
    ...
    def test_pep8_conformance_place(self):
        """Test that place.py conforms to PEP8."""
    ...
    def test_pep8_conformance_test_place(self):
        """Test that test_place.py conforms to PEP8."""
        pep8s = pycodestyle.StyleGuide(quiet=True)
...
class TestPlace(unittest.TestCase):
    ...
    def test_number_rooms_attr(self):
        """Test Place has attr number_rooms, and it's an int equal to 0"""
        place = Place()
    ...
    def test_number_bathrooms_attr(self):
        """Test Place has attr number_bathrooms, and it's an int equal  0"""
        place = Place()
    ...
    def test_max_guest_attr(self):
        """Test Place has attr max_guest, and it's an int equal to """
        place = Place()
    ...
    def test_price_by_night_attr(self):
        """Test Place has attr price_by_night, and it's an int equal to0"""
        place = Place()
    ...
    def test_latitude_attr(self):
        """Test Place has attr latitude, and it's a float equal 0.0"""
        place = Place()
    ...
    def test_longitude_attr(self):
        """Test Place has attr longitude, and it's a float equal to 0.0"""
        place = Place()
    ...
    def test_to_dict_values(self):
        ...
        self.assertEqual(new_d["created_at"], p.created_at.strftime(tim_format))
        self.assertEqual(new_d["updated_at"], p.updated_at.strftime(tim_format))
