...
class TestHBNBCommand_help(unittest.TestCase):
    ...
    def test_help_show(self):
        h = ("Usage: show classes and id as well as name.\n        "
             "Display the string rep of a class inst of"
             " a given id.")
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help_all(self):
        h = ("Usage: all classes displayed\n        "
             "Display string repr of all inst of a given class"
             ".\n        when class is not specified, displays all "
             "objects.")
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help_update(self):
        h = ("Usage: update attributes eg class,time,name id and city\n        "
